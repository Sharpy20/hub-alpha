...
export const ALL_GUIDES: GuideItem[] = [
  ...
  { id: "s117-meeting", title: "S117 Meeting Request", description: "Request Social Care attendance at S117 aftercare meeting (S117 patients only)", icon: "⚖️", gradient: "from-purple-600 to-purple-800", category: "Legal & Advocacy", viewerPath: "/guides/s117-meeting" },
  ...
  { id: "informal-patient-contract", title: "Informal Admission - Gatekeeping & Agreement", description: "The gatekeeping assessment and the informal admission questionnaire that sets shared expectations", icon: "🤝", gradient: "from-sky-500 to-blue-700", category: "Nurse Tools", viewerPath: "/guides/informal-patient-contract" },
  ...
  { id: "no-smoking", title: "Smoke-Free Ward - Your Legal Duty", description: "Why smoking on the ward is a staff accountability issue and what to do when you see it", icon: "🚭", gradient: "from-red-600 to-orange-700", category: "Restrictive Practice", viewerPath: "/guides/no-smoking" },
  ...
  { id: "pay-roster-faq", title: "Pay & Roster FAQ and Jargon Buster", description: "The questions staff ask most about pay, rostering and leave - plus every payslip and roster word translated, in one place", icon: "❓", gradient: "from-slate-600 to-slate-800", category: "Learning & Development", viewerPath: "/guides/pay-roster-faq" },
];
