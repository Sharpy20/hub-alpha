...
const ALL_GUIDES: GuideItem[] = [
  ...
  { id: "mental-state-exam", title: "Mental State Examination", description: "Interactive MSE builder - pick words per domain, copy to notes", icon: "\uD83E\uDDE0", gradient: "from-purple-500 to-purple-700", category: "Clinical Assessment", viewerPath: "/guides/mental-state-exam" },
  { id: "risk-assessment", title: "Risk Formulation & Management Plan", description: "Interactive builder - write a personalised formulation and RMP for SystemOne", icon: "\u26A0\uFE0F", gradient: "from-rose-500 to-red-700", category: "Clinical Assessment", viewerPath: "/guides/risk-assessment" },
