...
export const RMP_SECTIONS: RiskSection[] = [
  ...
  },
  {
    ...
    trustExamples: "manage: 1:1 time, hand over risk items + full search, PRN, time off the ward, medical review, arrange a risk strategy meeting. prevent: de-escalation, structured activity.",
  ...
  },
  {
    ...
    hint: "Escalation thresholds - when and what. The mandatory MDT line is added automatically, so you do not need to write it.",
    // NOTE: an MDT review and a risk strategy meeting are two DIFFERENT processes
    // and must not read as interchangeable (Mike, 20 Aug 2026). The chips name
    // them separately, and q_escalate's hint spells the difference out.
...
export const RMP_RISK_CHIPS: Record<string, Partial<Record<RmpSectionId, RiskChipGroup[]>>> = {
  ...
  "suicide": {
    ...
    next: [{ words: ["increase to 1:1 / eyesight obs", "urgent psychiatric review", "review medication", "arrange a risk strategy meeting", "request an urgent MDT review", "consider PICU", "review leave status"] }],
  },
  "violence and aggression": {
  ...
  "risk to others": {
    ...
    prevent: [
      { label: MANAGE, words: ["maintain safe staffing and observation", "separate from the person at risk", "remove potential weapons / items", "de-escalate", "offer PRN", "clear consistent boundaries", "request urgent staff support", "arrange a risk strategy meeting"] },
  ...
  "AWOL / absconsion": {
    ...
    next: [{ words: ["review and tighten observation level", "review leave / legal status with MDT", "complete AWOL paperwork / inform police if missing", "arrange a risk strategy meeting", "consider locked-door / PICU review"] }],
  },
  "medication non-concordance": {
  ...
  "substance misuse": {
    ...
    prevent: [
      { label: MANAGE, words: ["physical observations (NEWS2)", "manage withdrawal as prescribed", "search per policy if indicated", "medical review", "drug screen where appropriate", "remove substances / paraphernalia", "review leave and visitors", "arrange a risk strategy meeting"] },
    ...
    next: [{ words: ["medical review (intoxication / withdrawal)", "review leave and visitor arrangements", "arrange a risk strategy meeting", "refer to substance-misuse service", "physical health escalation if unwell"] }],
  },
  "paranoia / persecutory beliefs": {
    ...
    prevent: [
      { label: MANAGE, words: ["calm non-confrontational approach", "neither collude with nor directly challenge beliefs", "offer reassurance and space", "offer PRN", "consistent trusted staff", "reduce perceived threats / stimulation", "medical review", "arrange a risk strategy meeting"] },
  ...
  "mania / impulsivity": {
    ...
    prevent: [
      { label: MANAGE, words: ["reduce stimulation / low-stimulus area", "offer PRN", "clear simple boundaries", "limit access to means of harm / overspending", "redirect energy to safe activity", "protect sleep", "medical review", "arrange a risk strategy meeting"] },
  ...
  "diet and nutrition": {
    ...
    prevent: [
      { label: MANAGE, words: ["monitor and record food and fluid intake", "offer preferred foods and supplements", "supportive mealtime presence / supervision", "regular weights and physical observations", "dietitian and medical review", "offer fortified drinks / snacks", "manage refeeding risk as prescribed", "arrange a risk strategy meeting"] },
    ...
    next: [{ words: ["urgent medical review / bloods", "dietitian referral or review", "consider MEED guidance and physical risk", "arrange a risk strategy meeting", "capacity / MHA if refusing essential intake", "physical health escalation (NEWS2)"] }],
  },
  "falls": {
  ...
  "vulnerability / exploitation": {
    ...
    prevent: [
      { label: MANAGE, words: ["supervise peer interactions", "safeguard money and valuables", "separate from the exploiting peer", "1:1 support and reassurance", "remove access to the person exploiting them", "raise a safeguarding concern", "arrange a risk strategy meeting"] },
  ...
  "sexual disinhibition": {
    ...
    prevent: [
      { label: MANAGE, words: ["calm clear boundaries and redirection", "maintain personal space / protect others", "same-gender care where appropriate", "remove from the situation / offer privacy", "offer PRN if agitated", "document and Datix incidents", "arrange a risk strategy meeting"] },
  ...
  "financial exploitation": {
    ...
    prevent: [
      { label: MANAGE, words: ["safeguard cards, cash and valuables", "supervise / limit access to finances", "separate from the person exploiting them", "raise a safeguarding concern", "document concerns", "involve appointee / family where appropriate", "arrange a risk strategy meeting"] },
    ...
    next: [{ words: ["safeguarding referral", "involve social care / appointee", "arrange a risk strategy meeting", "police if a crime occurs", "review supervision level"] }],
  },
  "homelessness / housing instability": {
    ...
    next: [{ words: ["escalate to social work / housing team", "Duty to Refer if not already done", "request an urgent MDT review", "review at a discharge planning meeting", "delay discharge until housing is safe", "involve local authority / commissioners"] }],
  },
  "cognitive impairment / confusion": {
    ...
    next: [{ words: ["medical review / delirium workup", "investigate reversible causes", "OT / memory assessment referral", "increase supervision if unsafe", "review environment / placement"] }],
  },
  "discharge risk": {
  ...
  "sleep disturbance": {
    ...
    next: [{ words: ["medical / medication review", "investigate underlying cause", "review night-time observations"] }],
  },
  "infection / delirium": {
    ...
    next: [{ words: ["escalate per NEWS2 / sepsis protocol", "urgent medical review or 999", "transfer to acute care if needed", "request an urgent MDT review", "request a duty doctor review", "isolate / IPC measures if required"] }],
  },
  "risk to family": {
    ...
    prevent: [
      { label: MANAGE, words: ["risk-assess and review leave and visits", "supervised or restricted contact where needed", "safety planning with the family", "de-escalate around contact", "inform and involve safeguarding", "document and share risk", "arrange a risk strategy meeting"] },
  ...
  "child sexual abuse": {
    ...
    next: [{ words: ["refer to children's social care", "inform the ward safeguarding lead", "police referral where advised", "safeguarding strategy meeting", "MDT review of all leave and contact"] }],
  },
  "child physical abuse": {
    ...
    next: [{ words: ["refer to children's social care", "inform the ward safeguarding lead", "safeguarding strategy meeting", "police referral where advised", "MDT review before any discharge home"] }],
  },
  "child organisational abuse": {
    ...
    next: [{ words: ["refer to children's social care", "inform the ward safeguarding lead", "raise with the local authority designated officer", "safeguarding strategy meeting", "escalate through the trust safeguarding team"] }],
  },
  "child emotional abuse": {
  ...
  "child exposure to domestic abuse": {
    ...
    next: [{ words: ["refer to children's social care", "MARAC referral", "inform the ward safeguarding lead", "safeguarding strategy meeting", "review discharge address at the MDT"] }],
  },
  "child financial abuse": {
    ...
    next: [{ words: ["refer to children's social care", "inform the ward safeguarding lead", "benefits or appointeeship review", "professionals meeting"] }],
  },
  "child neglect": {
    ...
    next: [{ words: ["refer to children's social care", "inform the ward safeguarding lead", "safeguarding strategy meeting", "escalate out of hours to the emergency duty team", "MDT review before discharge home"] }],
  },
  // ---- Domain 7 gaps --------------------------------------------------------
  "unsafe home / appliances": {
...
// observable signs ARE the presentation), so it is not repeated here.
//
// "judgement" stays GENERIC on purpose. Its chips are severity labels (low /
// moderate / high, short and medium term) that the clinician picks for
// themselves. Writing per-risk versions would have the tool suggesting a risk
// LEVEL for a named risk, which is the line this tool does not cross - it offers
// vocabulary, it never rates or stratifies risk.
//
...
export const FORMULATION_RISK_CHIPS: Record<string, Partial<Record<FormulationSectionId, RiskChipGroup[]>>> = {
  "self-harm": {
    ...
    pattern: [{ words: ["escalating in frequency", "escalating in the method used", "a long-standing coping strategy", "new to this admission", "clustered around particular events", "settles then returns after discharge"] }],
    protective: [{ words: ["will hand items over when asked", "tells staff before acting", "responds to named-nurse 1:1s", "wants the wounds to heal", "children or pets at home", "uses distraction when offered", "fragile and easily lost when low"] }],
    engagement: [{ words: ["talks openly about the urges", "hides the injuries", "minimises how serious it is", "will accept help afterwards but not before", "engages better with one familiar member of staff", "sees it as the only thing that works"] }],
  },
  "suicide": {
    ...
    pattern: [{ words: ["ideation moving towards planning", "previous attempts increasing in lethality", "a first presentation", "recurs at the same time each year", "settled on the ward, rises on leave", "long-standing thoughts with recent change"] }],
    protective: [{ words: ["says they would not act on it", "future plans they hold on to", "family or dependents they will not leave", "faith or cultural beliefs", "no current access to means", "accepts 1:1 support", "protection depends on the ward environment"] }],
    engagement: [{ words: ["tells staff when the thoughts get worse", "guarded about the plan", "denies intent but the behaviour says otherwise", "will not discuss it with the team", "opens up to one person only", "asks for help before acting"] }],
  },
  "violence and aggression": {
    ...
    pattern: [{ words: ["escalating over this admission", "the same trigger every time", "long-standing pattern going back years", "new since a change in medication or mental state", "verbal only so far", "previously required restraint"] }],
    protective: [{ words: ["responds to de-escalation", "walks away when given space", "warns staff before losing control", "accepts PRN", "good relationship with particular staff", "no history of using weapons", "settles quickly afterwards"] }],
    engagement: [{ words: ["can talk about what set it off", "blames others entirely", "remorseful afterwards", "denies it happened", "will work on triggers with staff", "sees staff as the problem"] }],
  },
  "risk to others": {
    ...
    pattern: [{ words: ["escalating", "recurs when unwell", "long-standing", "new to this presentation", "linked to a specific person", "reduces when mental state improves"] }],
    protective: [{ words: ["no history of acting on the thoughts", "avoids the person concerned", "tells staff about the thoughts", "responds to treatment", "supportive family who will alert us", "boundaries hold on the ward"] }],
    engagement: [{ words: ["discusses the thoughts openly", "guarded about who it concerns", "does not see it as a risk", "will accept treatment", "conceals when mental state changes"] }],
  },
  "AWOL / absconsion": {
    ...
    pattern: [{ words: ["repeated attempts this admission", "one previous episode", "always at the same time of day", "increases when leave is refused", "long history across admissions", "new since a change in legal status"] }],
    protective: [{ words: ["returns of their own accord", "tells staff they want to leave rather than going", "accepts escorted leave instead", "reasons to stay on the ward", "family will bring them back", "settles when leave is planned"] }],
    engagement: [{ words: ["negotiates leave rather than going", "does not accept the need to stay", "hides plans to leave", "understands the legal position", "will agree a plan and keep to it"] }],
  },
  "medication non-concordance": {
    ...
    pattern: [{ words: ["stops every time after discharge", "intermittent adherence", "first refusal this admission", "linked to side effects", "worsens as insight drops", "adheres when supervised only"] }],
    protective: [{ words: ["accepts depot", "will take medication from one particular nurse", "accepts it when the reasons are explained", "family prompt at home", "has felt the benefit before", "concordance improves as mental state settles"] }],
    engagement: [{ words: ["asks about side effects", "will not discuss medication", "believes they do not need it", "accepts a trial", "hides or spits out doses", "will negotiate the dose or timing"] }],
  },
  "substance misuse": {
    ...
    pattern: [{ words: ["daily use before admission", "relapses on leave", "long-standing dependence", "recent escalation", "abstinent on the ward", "linked to particular company"] }],
    protective: [{ words: ["wants to stop", "accepts substitute prescribing", "engaged with a drug and alcohol service", "avoids people who use", "no use on the ward", "abstinent periods in the past"] }],
    engagement: [{ words: ["open about use", "understates how much", "denies use despite results", "will engage with a service", "sees it as the only relief", "willing to test"] }],
  },
  "paranoia / persecutory beliefs": {
    ...
    pattern: [{ words: ["fixed and long-standing", "fluctuates with mental state", "new this episode", "widening to include more people", "recedes with treatment", "worse at night"] }],
    protective: [{ words: ["accepts reassurance", "does not act on the beliefs", "trusts one member of staff", "responds to antipsychotic treatment", "family can talk them down", "beliefs do not involve anyone on the ward"] }],
    engagement: [{ words: ["shares what they believe", "guarded and watchful", "will not name who is involved", "accepts treatment despite the beliefs", "includes staff in the beliefs", "can consider another explanation"] }],
  },
  "mania / impulsivity": {
    ...
    pattern: [{ words: ["escalating over days", "a familiar relapse pattern", "first episode", "cyclical with a known season", "settling with treatment", "worsens with disturbed sleep"] }],
    protective: [{ words: ["accepts medication early in an episode", "family recognise the early signs", "an advance statement in place", "sleep returning", "accepts a quieter environment", "has come through episodes before"] }],
    engagement: [{ words: ["recognises the early signs", "enjoys the elevated mood and resists treatment", "no insight while elevated", "will accept help from family", "agrees a plan when settled"] }],
  },
  "self-neglect / ADLs": {
    ...
    pattern: [{ words: ["gradual decline over months", "sudden change linked to mental state", "long-standing and lifelong", "improves in hospital and slips at home", "worsening with physical health", "first time it has been noticed"] }],
    protective: [{ words: ["accepts prompting", "manages some tasks independently", "a relative who checks in", "a package of care already in place", "wants to stay in their own home", "accepts help once trust is built"] }],
    engagement: [{ words: ["accepts help when offered", "denies there is a problem", "sees the concern as interference", "will accept practical help but not personal care", "engages with one worker only"] }],
  },
  "diet and nutrition": {
    ...
    pattern: [{ words: ["steady weight loss", "long-standing restriction", "new since this episode", "fluctuates with mood", "improving with supervision", "worse when distressed"] }],
    protective: [{ words: ["eats with encouragement", "accepts supplements", "eats in company", "no physical complications yet", "wants to gain weight", "accepts monitoring"] }],
    engagement: [{ words: ["talks about eating openly", "conceals what has been eaten", "denies any difficulty", "accepts dietitian input", "distressed by being weighed", "will agree a meal plan"] }],
  },
  "falls": {
    ...
    pattern: [{ words: ["repeated falls this admission", "one fall so far", "increasing as mobility declines", "linked to medication changes", "always at night", "stable with the current aids"] }],
    protective: [{ words: ["uses the walking aid", "calls for help", "steady with supervision", "good footwear", "no injury from previous falls", "physiotherapy input in place"] }],
    engagement: [{ words: ["accepts help to mobilise", "overestimates what they can manage", "will not use the aid", "accepts a falls assessment", "hides that a fall has happened"] }],
  },
  "vulnerability / exploitation": {
    ...
    pattern: [{ words: ["a long-standing pattern of being taken advantage of", "recent and linked to a new acquaintance", "repeats with each admission", "escalating financially", "settles while an inpatient"] }],
    protective: [{ words: ["recognises when they are being used", "will tell staff about it", "trusted family involved", "no contact with the person concerned", "safe accommodation", "accepts advocacy"] }],
    engagement: [{ words: ["talks about the relationship openly", "protects the person involved", "does not see it as exploitation", "accepts safeguarding support", "fears losing the relationship"] }],
  },
  "sexual disinhibition": {
    ...
    pattern: [{ words: ["escalating with mental state", "out of character and new", "long-standing pattern", "reduces with treatment", "confined to periods of elevated mood", "recurs each admission"] }],
    protective: [{ words: ["responds to boundaries", "no history of anyone being harmed", "insight returns as mental state settles", "accepts redirection", "same-sex areas respected", "apologetic afterwards"] }],
    engagement: [{ words: ["accepts the boundary when it is set", "does not see the impact on others", "embarrassed once well", "will discuss it with staff", "resents being challenged"] }],
  },
  "refusal to engage": {
    ...
    pattern: [{ words: ["complete withdrawal since admission", "improving slowly", "long-standing mistrust of services", "new since a particular event", "engages with some staff and not others"] }],
    protective: [{ words: ["engages with one named person", "accepts practical help", "will attend if a family member comes", "no active hostility", "engages better in their own room", "has engaged well in the past"] }],
    engagement: [{ words: ["will sit with staff without talking", "declines all contact", "engages around practical things only", "responds to written information", "engages more when nothing is asked of them"] }],
  },
  "physical health deterioration": {
    ...
    pattern: [{ words: ["deteriorating over days", "stable but fragile", "long-term condition with recent change", "new problem this admission", "improving with treatment", "recurring infections"] }],
    protective: [{ words: ["reports symptoms", "accepts observations and blood tests", "takes physical health medication", "GP and specialist involvement in place", "responds quickly to treatment", "family notice changes early"] }],
    engagement: [{ words: ["reports symptoms early", "does not report pain or symptoms", "declines physical examination", "accepts treatment once explained", "attends appointments with support"] }],
  },
  "fire risk": {
    ...
    pattern: [{ words: ["previous fire setting", "recent near-miss", "long-standing fascination with fire", "linked to periods of distress", "accidental rather than deliberate", "escalating"] }],
    protective: [{ words: ["hands lighters and matches over", "smokes only in the designated area", "no deliberate fire setting", "accepts supervision when smoking", "understands the danger", "no access to accelerants"] }],
    engagement: [{ words: ["accepts the restrictions", "conceals lighters", "does not accept the risk", "will discuss what fire means to them", "cooperates with searches"] }],
  },
  "hoarding": {
    ...
    pattern: [{ words: ["long-standing and lifelong", "worsening since a bereavement", "new since this episode", "the home increasingly unusable", "improves briefly after a clearance and returns"] }],
    protective: [{ words: ["accepts help sorting", "keeps exits clear", "recognises the fire risk", "allows professionals in", "a relative who can support", "wants to stay in the property"] }],
    engagement: [{ words: ["allows the conversation", "distressed by any removal", "denies the extent", "will work with an occupational therapist", "wants control over what goes"] }],
  },
  "financial exploitation": {
    ...
    pattern: [{ words: ["ongoing for months", "recent and linked to a new relationship", "repeats with the same person", "escalating amounts", "stops while an inpatient"] }],
    protective: [{ words: ["accounts protected or appointeeship in place", "recognises what is happening", "will tell staff", "no contact with the person concerned", "family oversight", "accepts money advice"] }],
    engagement: [{ words: ["talks about money openly", "protects the person taking it", "embarrassed to discuss it", "accepts help with benefits", "does not see it as abuse"] }],
  },
  "homelessness / housing instability": {
    ...
    pattern: [{ words: ["repeated evictions", "first time homeless", "sofa-surfing for months", "tenancy at risk but not lost", "long-standing rough sleeping", "settled until this admission"] }],
    protective: [{ words: ["a tenancy still held", "family willing to accommodate", "engaged with housing", "rent arrears being addressed", "a duty to refer already made", "wants to stay in the area"] }],
    engagement: [{ words: ["engages with housing appointments", "misses housing appointments", "declines temporary accommodation offered", "accepts help to apply", "will not disclose where they are staying"] }],
  },
  "cognitive impairment / confusion": {
    ...
    pattern: [{ words: ["gradual decline", "sudden onset", "fluctuating through the day", "worse at night", "stable with support", "deteriorating since admission"] }],
    protective: [{ words: ["orientates with prompting", "familiar routine helps", "family present regularly", "responds to a quiet environment", "recognises staff", "reversible cause being treated"] }],
    engagement: [{ words: ["accepts prompting and redirection", "resists personal care", "distressed by unfamiliar staff", "settles with a familiar face", "cannot retain the safety information"] }],
  },
  "discharge risk": {
    ...
    pattern: [{ words: ["previous readmission within weeks", "first discharge from hospital", "repeated failed discharges", "settled placement until now", "improving with a longer stay"] }],
    protective: [{ words: ["a confirmed address to go to", "community team already allocated", "family able to support the first week", "medication supply and follow-up arranged", "wants to go home and stay well", "a crisis plan they helped write"] }],
    engagement: [{ words: ["involved in discharge planning", "disengages as discharge approaches", "unrealistic about the support needed", "agrees the plan and follows it", "avoids discharge conversations"] }],
  },
  "sleep disturbance": {
    ...
    pattern: [{ words: ["worsening over the week", "long-standing insomnia", "reversed day and night", "improving with routine", "linked to elevated mood", "disturbed by the ward environment"] }],
    protective: [{ words: ["accepts a sleep routine", "responds to night sedation", "settles once reassured", "no daytime napping", "quiet room available", "sleep improving with treatment"] }],
    engagement: [{ words: ["reports how they slept", "denies any problem", "accepts sleep hygiene advice", "asks for medication only", "will try a routine"] }],
  },
  "infection / delirium": {
    ...
    pattern: [{ words: ["acute onset over hours", "recurring infections", "fluctuating through the day", "resolving with treatment", "first episode", "worse at night"] }],
    protective: [{ words: ["reversible cause identified", "responding to antibiotics", "accepts observations and bloods", "family able to say what is normal for them", "hydration maintained", "familiar staff reduce distress"] }],
    engagement: [{ words: ["accepts physical care", "resists observations", "cannot retain explanations", "settles with familiar staff", "distressed by examination"] }],
  },
  "risk to family": {
    ...
    pattern: [{ words: ["escalating at home", "long-standing conflict", "new since this episode", "always the same family member", "settles when apart", "worse after contact"] }],
    protective: [{ words: ["family able to keep themselves safe", "no contact currently", "recognises the impact on them", "responds to treatment", "family alert staff early", "contact supervised"] }],
    engagement: [{ words: ["talks about the relationship openly", "blames the family entirely", "wants to repair it", "does not accept there is a risk", "accepts supervised contact"] }],
  },
  "weapon access": {
    ...
    pattern: [{ words: ["repeated concealment", "one incident", "long history of carrying", "escalating threats", "no access on the ward", "linked to fear of others"] }],
    protective: [{ words: ["hands items over", "accepts searches", "no history of using a weapon", "carries out of fear rather than intent", "no access at the discharge address", "police involvement resolved"] }],
    engagement: [{ words: ["accepts the searches", "conceals items", "explains why they carry", "does not accept the concern", "cooperates once the reason is explored"] }],
  },
  "boundary violations": {
    ...
    pattern: [{ words: ["escalating with particular staff", "long-standing pattern", "new this admission", "reduces when boundaries are held consistently", "worse when unwell"] }],
    protective: [{ words: ["responds to a clear boundary", "accepts the reason for it", "no intimidation involved", "consistent team approach works", "insight returns when settled"] }],
    engagement: [{ words: ["accepts the boundary", "tests every boundary", "sees the boundary as rejection", "will discuss it afterwards", "splits the team"] }],
  },
  "observations / refusal of obs": {
    ...
    pattern: [{ words: ["refuses every time", "accepts some and not others", "new since the level increased", "improving as trust builds", "worse with particular staff"] }],
    protective: [{ words: ["accepts a chosen member of staff", "accepts physical health checks", "understands why the level is set", "level being reviewed regularly", "no distress once explained"] }],
    engagement: [{ words: ["asks why the level is set", "hostile about being watched", "accepts the least-restrictive option", "will negotiate who observes", "distressed by the intrusion"] }],
  },
  ...
  "child in care": {
    ...
    pattern: [{ words: ["long-standing separation", "recent removal", "proceedings ongoing", "contact settled until recently", "repeated breakdowns in contact"] }],
    protective: [{ words: ["contact happening as arranged", "working with the social worker", "realistic about the arrangements", "support around contact in place", "advocacy or legal advice engaged"] }],
    engagement: [{ words: ["works with children's services", "avoids the professionals involved", "hostile about the removal", "accepts support around contact", "will not discuss the child"] }],
  },
  "child protection plan": {
    ...
    pattern: [{ words: ["plan in place for months", "newly made", "escalated from a child in need plan", "repeated plans over the years", "step-down being considered"] }],
    protective: [{ words: ["engaging with the plan", "professionals able to see the child", "another safe adult in the household", "attending core group meetings", "honest about who is in the household"] }],
    engagement: [{ words: ["works with children's services", "hostile towards them", "attends meetings", "minimises the reasons for the plan", "asks what they need to do"] }],
  },
  "child sexual abuse": {
    ...
    pattern: [{ words: ["a disclosure made recently", "previous concerns on record", "an established pattern of seeking access", "concerns first raised this admission"] }],
    protective: [{ words: ["restrictions in place and kept to", "no unsupervised access", "children's services leading on contact", "another protective adult present", "the whole team briefed"] }],
    engagement: [{ words: ["accepts the restrictions", "denies the concern entirely", "seeks to negotiate contact", "engages with the safeguarding process", "minimises what happened"] }],
  },
  "child physical abuse": {
    ...
    pattern: [{ words: ["a recent incident", "repeated concerns over time", "escalating conflict at home", "first concern raised", "settled since separation"] }],
    protective: [{ words: ["supervised contact only", "engaging with parenting support", "another safe adult in the household", "stressors at home being addressed", "no further injuries reported"] }],
    engagement: [{ words: ["accepts help with parenting", "denies the injuries were caused", "blames the child", "works with children's services", "avoids professional contact"] }],
  },
  "child organisational abuse": {
    ...
    pattern: [{ words: ["concerns raised recently", "long-standing worries about the setting", "several children affected", "complaints previously dismissed"] }],
    protective: [{ words: ["the concern reported and taken up", "the child seen alone by a professional", "the family supported to complain", "children's services leading"] }],
    engagement: [{ words: ["reports the concern clearly", "afraid to raise it", "accepts support to complain", "does not want it escalated"] }],
  },
  "child emotional abuse": {
    ...
    pattern: [{ words: ["long-standing pattern in the relationship", "worse during adult conflict", "new since separation", "improving with family work"] }],
    protective: [{ words: ["speaks about the child warmly at times", "another warm adult in the child's life", "engaging with family work", "contact planned around the child"] }],
    engagement: [{ words: ["accepts family work", "does not see the harm", "blames the other parent", "wants the relationship to improve", "avoids the subject"] }],
  },
  "child exposure to domestic abuse": {
    ...
    pattern: [{ words: ["long-standing abuse in the household", "escalating", "recent separation", "police called repeatedly", "settled since leaving"] }],
    protective: [{ words: ["no longer living together", "engaging with domestic abuse support", "safety plan that includes the child", "a safe discharge address", "MARAC involvement"] }],
    engagement: [{ words: ["talks about what is happening", "minimises the abuse", "protects the other adult", "accepts specialist support", "not ready to leave"] }],
  },
  "child financial abuse": {
    ...
    pattern: [{ words: ["ongoing for some time", "recent and linked to a new adult in the household", "escalating debt", "settled once oversight was in place"] }],
    protective: [{ words: ["the child's needs being met day to day", "money arrangements reviewed", "another adult with oversight", "engaging with money advice"] }],
    engagement: [{ words: ["open about the money", "defensive about the arrangement", "accepts benefits advice", "does not see it as harmful"] }],
  },
  "child neglect": {
    ...
    pattern: [{ words: ["long-standing", "worse during this episode of illness", "first concern raised", "improving with support in place", "repeats each time they become unwell"] }],
    protective: [{ words: ["another adult meeting the child's needs", "family support package in place", "appointments being kept", "engaging with early help", "the child seen and doing well"] }],
    engagement: [{ words: ["accepts family support", "does not recognise the child's needs", "avoids professional visits", "asks for practical help", "works with children's services"] }],
  },
  "unsafe home / appliances": {
    ...
    pattern: [{ words: ["long-standing disrepair", "recent breakdown", "a previous near-miss or fire", "repairs requested and not done", "resolved once reported"] }],
    protective: [{ words: ["a working smoke alarm", "a responsive landlord", "repairs already booked", "a neighbour or relative who checks in", "recognises the danger"] }],
    engagement: [{ words: ["reports the problem", "does not see it as dangerous", "accepts a home safety visit", "reluctant to let anyone in", "chases the landlord themselves"] }],
  },
  "social isolation": {
    ...
    pattern: [{ words: ["years of withdrawal", "recent, since a bereavement or loss", "worse since admission", "improving with a routine", "repeats after every discharge"] }],
    protective: [{ words: ["one person they stay in touch with", "attends one activity", "a routine they keep to", "wants more contact", "known to a community group", "responds to 1:1 before groups"] }],
    engagement: [{ words: ["accepts 1:1 time", "declines every group", "will try if a familiar person goes too", "says they prefer their own company", "asks about activities"] }],
  },
};
