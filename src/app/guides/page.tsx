...
const ASSESSMENT_GUIDES: GuideItem[] = [
  ...
  { id: "safeguarding-adults-referral", title: "Safeguarding Adults Referral", description: "Section 42 Care Act 2014 - when and how to refer", icon: "\uD83D\uDEE1\uFE0F", gradient: "from-red-600 to-red-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/safeguarding-adults-referral" },
  { id: "safeguarding-children-referral", title: "Safeguarding Children Referral", description: "Starting Point referral process for child concerns", icon: "\uD83D\uDC76", gradient: "from-pink-600 to-pink-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/safeguarding-children-referral" },
  { id: "domestic-abuse-guide", title: "Domestic Abuse", description: "Recognising and responding to domestic abuse", icon: "\uD83C\uDFE0", gradient: "from-purple-600 to-purple-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/domestic-abuse-guide" },
  { id: "peer-conflict-guide", title: "Peer-on-Peer Conflict", description: "When to escalate patient conflict to safeguarding", icon: "\u26A0\uFE0F", gradient: "from-amber-600 to-amber-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/peer-conflict-guide" },
  { id: "information-sharing", title: "Information Sharing", description: "Seven golden rules and GDPR guidance for safeguarding", icon: "\uD83D\uDD17", gradient: "from-blue-600 to-blue-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/information-sharing" },
  { id: "escalation-pathway", title: "Escalation Pathway (Children)", description: "Bronze, Silver and Gold levels for complex YP cases", icon: "\uD83D\uDCC8", gradient: "from-orange-600 to-orange-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/escalation-pathway" },
  { id: "online-safety-children", title: "Online Safety and Children", description: "Nudes, cyberbullying, sextortion and screen time", icon: "\uD83C\uDF10", gradient: "from-cyan-600 to-cyan-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/online-safety-children" },
  { id: "honour-based-abuse", title: "HBA, FGM and Forced Marriage", description: "Honour-based abuse, female genital mutilation and forced marriage", icon: "\uD83D\uDEE1\uFE0F", gradient: "from-rose-700 to-rose-900", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/honour-based-abuse" },
  { id: "modern-slavery-radicalisation", title: "Modern Slavery and Radicalisation", description: "Spotting the signs and making Prevent referrals", icon: "\u26D3\uFE0F", gradient: "from-gray-600 to-gray-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/modern-slavery-radicalisation" },
  { id: "faith-belief-abuse", title: "Abuse Linked to Faith or Belief", description: "Recognising abuse linked to spirit possession, witchcraft or cultural practices", icon: "\uD83D\uDE4F", gradient: "from-violet-600 to-violet-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/faith-belief-abuse" },
  { id: "send-safeguarding", title: "SEND and Safeguarding", description: "Safeguarding children with special educational needs and disabilities", icon: "\uD83D\uDCDA", gradient: "from-teal-600 to-teal-800", category: "Safeguarding", guideType: "assessments", viewerPath: "/how-to/send-safeguarding" },
