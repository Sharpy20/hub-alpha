...
export const SERVICES: Service[] = [
  ...
  { id: "cmht", name: "Living Well / CMHT (Adults)", cluster: "community", areas: CC, include: [{ label: "18+ with significant MH needs not met by primary care / IAPT", test: (f) => f.age >= 18 && (severe(f) || (anyDx(f) && f.risk !== "low")) }], exclude: [], contact: "livingwellderbyshire.org.uk", note: "Living Well - short-term (up to 12 weeks) for people too unwell for primary care but below the CMHT threshold. Working age 18-65 (will see 65+ where needs align). GP referral. Serious/complex MH incl. dual diagnosis, complex trauma, homelessness - SMI not an exclusion. Called Derby Wellbeing in the city.", catchmentNote: "By registered GP surgery (each Living Well team covers set surgeries)." },
